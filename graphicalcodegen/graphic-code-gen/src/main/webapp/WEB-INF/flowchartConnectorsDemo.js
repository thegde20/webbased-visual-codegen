...
//				connector: ["Flowchart", { stub: [40, 60], gap: 10, cornerRadius: 5, alwaysRespectStubs: true }],
				connector: ["Flowchart", { stub: [10, 50], gap: 10, cornerRadius: 5, alwaysRespectStubs: true }],
...
//                	["Label", { location: [0.5, -0.5], label: "Drop", cssClass: "endpointTargetLabel" }]
            ...
            /*
			_addEndpoints("window5", ["BottomCenter"], ["LeftMiddle", "TopCenter", "RightMiddle"]);
			_addEndpoints("window4", ["TopCenter", "BottomCenter"], ["LeftMiddle", "RightMiddle"]);
//			_addEndpoints("window2", ["LeftMiddle", "BottomCenter"], ["TopCenter", "RightMiddle"]);
			_addEndpoints("window2", ["BottomCenter"], ["TopCenter"]);
			_addEndpoints("window3", ["RightMiddle", "BottomCenter"], ["LeftMiddle", "TopCenter"]);
//			_addEndpoints("window1", ["LeftMiddle", "RightMiddle"], ["TopCenter", "BottomCenter"]);
			_addEndpoints("window1", ["LeftMiddle", "RightMiddle", "BottomCenter"], ["TopCenter"]);
*/

			_addEndpoints("window5", ["BottomCenter"], ["LeftMiddle", "TopCenter", "RightMiddle"]);
			_addEndpoints("window4", ["BottomCenter"], ["LeftMiddle", "TopCenter", "RightMiddle"]);
			_addEndpoints("window2", ["BottomCenter"], ["LeftMiddle", "TopCenter", "RightMiddle"]);
			_addEndpoints("window3", ["BottomCenter"], ["LeftMiddle", "TopCenter", "RightMiddle"]);
			_addEndpoints("window1", ["BottomCenter", "RightMiddle"], ["LeftMiddle", "TopCenter"]);
  ...
  var serializedData;
			...
			jsPlumb.bind("jsPlumbConnection", function(connInfo, originalEvent) { 
				init(connInfo.connection);
                         ...
                         serializedData = JSON.stringify(connections);
                        // alert("conection"+serializedData);
			});
